...
이번 프로토타입의 일환으로, 우리는 **YOLOv8 모델**을 활용하는 방법을 탐색해보았습니다.  
이 모델은 https://www.yolov8.com[yolov8,window=_blank]에서 온라인으로 확인하고 다운로드할 수 있습니다.
...
이제 YOLOv8 모델을 실제로 사용해보며,  
**정지 이미지(static image)** 속 자동차를 어떻게 인식하는지를 살펴보겠습니다.
